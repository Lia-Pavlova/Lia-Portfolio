...
export default function Education() {
  const [additionalGoItData, setAdditionalGoIt] = useState([])
  const [additionalAecData, setAdditionalAec] = useState([])
  const [educationData, setEducation] = useState([])
  const [workExpData, setWorkExp] = useState([])
  useEffect(() => {
    const additionalGoItData = education.additionalGoIt
    const additionalAecData = education.additionalAec
    const educationData = education.education
    const workExpData = education.workExp
    setAdditionalGoIt(additionalGoItData)
    setAdditionalAec(additionalAecData)
    setEducation(educationData)
    setWorkExp(workExpData)
  }, [additionalGoItData, additionalAecData, educationData, workExpData])
    ...
    <section className="education section" id="education">
      <div className="container">
        ...
        <div className="tab-content" id="pills-tabContent">
          ...
          >
            <div className="row ">
              {additionalGoItData.map((additionalGoIt) => {
                return (
                  <div className="col-md-4 d-flex align-items-stretch">
                    <div className="card bg-darkblue additional-education-card">
                      <div className="card-body">
                        <p className="card-text">{additionalGoIt.year}</p>
                        <a
                          href={additionalGoIt.site}
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                          <h5 className="card-title text-white">
                            {additionalGoIt.companyName}
                          </h5>
                        </a>

                        <ul>
                          <li>{additionalGoIt.role1}</li>
                        </ul>
                        <div className="links">
                          <ul>
                            <li>
            ...
            <div className="row ">
              {additionalAecData.map((additionalAec) => {
                return (
                  <div className="col-md-4 d-flex align-items-stretch">
                    <div className="card bg-darkblue additional-education-card">
                      <div className="card-body">
                        <p className="card-text">{additionalAec.year}</p>
                        <a
                          href={additionalAec.site}
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                          <h5 className="card-title text-white">
                            {additionalAec.companyName}
                          </h5>
                        </a>

                        <ul>
                          <li>{additionalAec.role1}</li>
                        </ul>
                        <div className="links">
                          <ul>
                            <li>
